...
```text
%USERPROFILE%\.codex\doc-to-md\doc-to-md.bat --help
```
...
---
name: doc-to-md
description: "要把 PDF、EPUB、Word／PowerPoint／Excel、掃描檔、截圖或圖片資料夾轉成乾淨 Markdown 時使用。"
---
...
Windows：
```
%USERPROFILE%\.codex\doc-to-md\doc-to-md.bat --auto C:\Users\你的名字\Desktop\書名.pdf -o C:\Users\你的名字\Desktop\
```
...
```powershell
%USERPROFILE%\.codex\doc-to-md\doc-to-md.bat --help
%USERPROFILE%\.codex\vlm-to-md\vlm-to-md.bat --help
```
