...
> 2026-08-25 建立。以校準題與保留題的迴圈萃取個人寫作風格，三 Agent 共用版本。
...
| 使用者回饋 | 可更新的規則 |
| :-- | :-- |
| 「這段讀起來像新聞稿。」 | 開頭改用自己碰到的具體場景，不先下結論。 |
| 「我平常不會用『值得注意的是』。」 | 把這類書面轉場詞列入禁用清單，改用口語接續。 |
| 「一段裡塞了三個專有名詞。」 | 每段最多留一個專有名詞，出現時緊接一句白話解釋。 |
...
| 類別 | 處理方式 |
| :-- | :-- |
| 仍然像現在的自己 | 列為 `references` 候選 |
| 寫法值得學、內容已過期 | 收進來但標「只借結構」，時效資訊與行動呼籲都不學 |
| 私人、一次性、純通知，或本人不希望被模仿 | 不收進素材庫 |
