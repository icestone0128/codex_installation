...
- [ ] 開新 Codex 對話後，用「landing page」、「銷售頁」、「報名頁」、「活動頁」、「既有文案轉 HTML」或「CMS HTML」可觸發。
...
cat > "{{CODEX_HOME}}/skills/landing-page/README.md" <<'CODEX_LAZYPACK_LANDING_PAGE_README_MD_8EC9A00BFD'
# landing-page
...
CODEX_LAZYPACK_LANDING_PAGE_README_MD_8EC9A00BFD

# landing-page/SKILL.md
mkdir -p "$(dirname "{{CODEX_HOME}}/skills/landing-page/SKILL.md")"
cat > "{{CODEX_HOME}}/skills/landing-page/SKILL.md" <<'CODEX_LAZYPACK_LANDING_PAGE_SKILL_MD_55B84175E7'
---
name: landing-page
description: Use when the user asks to create, rewrite, restyle, or convert a landing page, sales page, course page, event signup page, product launch page, or lead-capture page. Supports guided generation from a rough offer and CMS HTML layout mode for preserving complete existing copy while converting it into semantic, CMS-ready HTML. Trigger phrases include landing page, landing-page skill, 銷售頁, 報名頁, 課程頁, 活動頁, 產品頁, 既有文案轉 HTML, CMS HTML, and 幫我做 landing page.
metadata:
...
CODEX_LAZYPACK_LANDING_PAGE_SKILL_MD_55B84175E7

# landing-page/references/question-bank.md
mkdir -p "$(dirname "{{CODEX_HOME}}/skills/landing-page/references/question-bank.md")"
cat > "{{CODEX_HOME}}/skills/landing-page/references/question-bank.md" <<'CODEX_LAZYPACK_LANDING_PAGE_REFERENCES_QUESTION_BANK_MD_2EA5C4DBD5'
...
CODEX_LAZYPACK_LANDING_PAGE_REFERENCES_QUESTION_BANK_MD_2EA5C4DBD5

# landing-page/references/cms-html-mode.md
mkdir -p "$(dirname "{{CODEX_HOME}}/skills/landing-page/references/cms-html-mode.md")"
cat > "{{CODEX_HOME}}/skills/landing-page/references/cms-html-mode.md" <<'CODEX_LAZYPACK_LANDING_PAGE_REFERENCES_CMS_HTML_MODE_MD_FF18288BD1'
# CMS HTML Layout Mode
...
CODEX_LAZYPACK_LANDING_PAGE_REFERENCES_CMS_HTML_MODE_MD_FF18288BD1
...
cat > "{{CODEX_HOME}}/skills/landing-page/references/fallback-design-rules.md" <<'CODEX_LAZYPACK_LANDING_PAGE_REFERENCES_FALLBACK_DESIGN_RULES_MD_2EBFD99D12'
...
CODEX_LAZYPACK_LANDING_PAGE_REFERENCES_FALLBACK_DESIGN_RULES_MD_2EBFD99D12

# landing-page/references/uupm-integration.md
mkdir -p "$(dirname "{{CODEX_HOME}}/skills/landing-page/references/uupm-integration.md")"
cat > "{{CODEX_HOME}}/skills/landing-page/references/uupm-integration.md" <<'CODEX_LAZYPACK_LANDING_PAGE_REFERENCES_UUPM_INTEGRATION_MD_6A5C1F0105'
...
CODEX_LAZYPACK_LANDING_PAGE_REFERENCES_UUPM_INTEGRATION_MD_6A5C1F0105

# landing-page/templates/base.html
mkdir -p "$(dirname "{{CODEX_HOME}}/skills/landing-page/templates/base.html")"
cat > "{{CODEX_HOME}}/skills/landing-page/templates/base.html" <<'CODEX_LAZYPACK_LANDING_PAGE_TEMPLATES_BASE_HTML_DA7C237B85'
<!DOCTYPE html>
<html lang="zh-TW">
<head>
  <meta charset="UTF-8">
...
CODEX_LAZYPACK_LANDING_PAGE_TEMPLATES_BASE_HTML_DA7C237B85

# landing-page/templates/countdown.js
mkdir -p "$(dirname "{{CODEX_HOME}}/skills/landing-page/templates/countdown.js")"
cat > "{{CODEX_HOME}}/skills/landing-page/templates/countdown.js" <<'CODEX_LAZYPACK_LANDING_PAGE_TEMPLATES_COUNTDOWN_JS_63EABFED46'
(function () {
  'use strict';
...
CODEX_LAZYPACK_LANDING_PAGE_TEMPLATES_COUNTDOWN_JS_63EABFED46
