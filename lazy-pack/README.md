...
| LazyPack 自含式安裝文件 | `{{SETUP_REPO}}/lazy-pack/01...32.md` | 每個序號文件內嵌對應全域 skill 的完整安裝內容 |
...
- VoxCPM2 Voice Cloner Skill 以 [[32-VoxCPM2-Voice-Cloner-Skill-安裝]] 為準；runtime／模型快取放私有全域助手資料層，reusable voice profile 放全域助手資產，生成音檔放當次專案資料夾並排除 Git。
