...
21. [[21-SOIL-Teaching-Deck-Skill-安裝]]
...
| LazyPack 自含式安裝文件 | `{{SETUP_REPO}}/lazy-pack/01...21.md` | 每個序號文件內嵌對應全域 skill 的完整安裝內容 |
...
| 18 | `soil-teaching-deck` | [[21-SOIL-Teaching-Deck-Skill-安裝]] | 可直接安裝；SOIL 可編輯教學 PPTX |
| 19 | 其他內容製作類 skills | 對應序號文件 | 視需求安裝 |
...
- SOIL Teaching Deck skill 以 [[21-SOIL-Teaching-Deck-Skill-安裝]] 為準。
