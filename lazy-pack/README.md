...
29. [[29-Movie-Automation-Skill-安裝]]
...
| LazyPack 自含式安裝文件 | `{{SETUP_REPO}}/lazy-pack/01...29.md` | 每個序號文件內嵌對應全域 skill 的完整安裝內容 |
...
| 26 | `movie-automation` | [[29-Movie-Automation-Skill-安裝]] | 可直接安裝；原始影片到 YouTube / 社群影片上架包，含智能剪口播、字幕、文字稿、封面、metadata 與短片亮點 |
| 27 | 其他內容製作類 skills | 對應序號文件 | 視需求安裝 |
...
- Movie Automation Skill 以 [[29-Movie-Automation-Skill-安裝]] 為準。
