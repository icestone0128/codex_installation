...
| LazyPack 自含式安裝文件 | `{{SETUP_REPO}}/lazy-pack/01...31.md` | 每個序號文件內嵌對應全域 skill 的完整安裝內容 |
...
| 28 | `youtube-transcript-collector` | [[31-YouTube-Transcript-Collector-Skill-安裝]] | 可直接安裝；先建立 YouTube 影片總表 MD，再逐支抓取繁中字幕 MD，並用總表影片標題命名字幕檔 |
