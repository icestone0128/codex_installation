...
The source document is a 來源工具 å¤é¨ææ for moving source-tool configuration into a portable "AI brain" folder, backing it up, symlinking it back into `來源工具設定資料夾`, adding optional GitHub backup, generating a health-check script, and writing a migration manual.
...
| `000_Agent/` is created by the source guide | This user already has Arry Assistant data under `codex_installation/000_Agent` |
